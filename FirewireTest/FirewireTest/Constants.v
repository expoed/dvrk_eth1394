...
//For the commander memory address
`define ADDR_BC_RECEIVE		11'd128
`define ADDR_PC_REQ 			11'd0
`define ADDR_RESP_DATA 		11'd64
`define ADDR_DEFAULT		11'd0
`define SZ_BC_RECEIVE	11'd20
